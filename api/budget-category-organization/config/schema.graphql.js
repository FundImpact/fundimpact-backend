  ...
  resolver: {
    Query: {
      ...
      projectCountBudgetCatByOrg: {
        policies: ['application::budget-category-organization.addFilter'],
        resolverOf: 'application::budget-category-organization.budget-category-organization.project_count_budget_cat_by_org',
        resolver: async (obj, options, { context }) => {
          context.params = _.toPlainObject(options);
          context.request.body = _.toPlainObject(options.input);
          return await strapi.controllers['budget-category-organization'].project_count_budget_cat_by_org(context);
        }
      }
    },
    Mutation: {
