...
module.exports = {
    totalDeliverableAmount: async ctx => {
        try {
            ...
            where deliverable_sub_targets.project = ${ctx.params.where.project} and dtp.type = ${ctx.params.where.deliverable_target_project.type}   and COALESCE(deleted, false) <> true`)
